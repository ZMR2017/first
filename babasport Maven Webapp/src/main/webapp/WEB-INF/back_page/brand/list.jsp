...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<tbody class="pn-ltbody">
		...
		<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			...
			<td align="center">
			<a class="pn-opt" onclick="window.location.href='/brand/toedit.do?id=${entry.id}'" href="javascript:void(0)">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;} window.location.href='/brand/delete.do?id=${entry.id }&name=${name}&isDisplay=${isDisplay}'" href="javascript:void(0)">删除</a>
			</td>
		</tr>
