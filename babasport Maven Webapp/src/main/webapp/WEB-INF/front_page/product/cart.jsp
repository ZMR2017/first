...
<div class="w ofc case">
	<div class="confirm">
		...
		<div class="ofc pb40">
			...
			<c:forEach items="${buyCart.items}" var="item">
				<tr>
					<td class="nwp pic">
						<ul class="uls">
							<li>
								<a class="pic" title=" ${item.sku.product.name}" ><img alt="${item.sku.product.name}" src="${item.sku.product.img.allUrl }"></a>
								<dl>
			...
			<div class="page">
				<span class="l">
					<input type="button" onclick="window.open('/product/detail.shtml?id=278')" class="hand btn100x26c" title="继续购物" value="继续购物">
